...
const translations = {
  ka: {
    ...
    home: {
      ...
      shopBuilderDesc: 'შეაგროვე რუქსაკი, ანსამბლი და სხვა — 30% ფასდაკლება.',
      shopCta: 'ნახვა',
    ...
    gearBuilder: {
      ...
      homeDesc: 'აირჩიეთ რუქსაკი, ანსამბლი და სხვა — 30% ფასდაკლება.',
  ...
  en: {
    ...
    home: {
      ...
      shopBuilderDesc: 'Mix backpack, tent, and more — save 30% on bundles.',
      shopCta: 'Shop now',
    ...
    gearBuilder: {
      ...
      homeDesc: 'Mix backpack, tent, and more — 30% off bundles.',
