...
const translations = {
  ka: {
    ...
    home: {
      ...
      shopBuilderDesc: 'შეაგროვე რუქსაკი, ანსამბლი და სხვა — 20% ფასდაკლება.',
      shopCta: 'ნახვა',
    ...
    searchPage: {
      ...
      emptyHint: 'სცადეთ სხვა სიტყვა — ანსამბლი, რუქსაკი, კომპლექტი…',
    ...
    gearBuilder: {
      ...
      homeDesc: 'აირჩიეთ რუქსაკი, ანსამბლი და სხვა — 20% ფასდაკლება.',
