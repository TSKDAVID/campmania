...
const translations = {
  ka: {
    ...
    gearBuilder: {
      ...
      confirmSave: 'შენახვა',
      updateExisting: 'განახლება',
      saveAsNew: 'ახალ კომპლექტად შენახვა',
      startAnotherKit: 'ახალი კომპლექტი',
      cancelSave: 'გაუქმება',
    ...
    ordersPage: {
      ...
      subtitle: 'თქვენი ქირისა და ყიდვის შეკვეთები ერთ ადგილას.',
      filterTitle: 'ძებნა',
      orderNumber: 'შეკვეთის №',
      confirmationNumber: 'დადასტურების №',
      search: 'ძებნა',
      searching: 'ძებნა…',
      clear: 'გასუფთავება',
      noOrders: 'ჯერ არ გაქვთ შეკვეთები',
      noOrdersDesc:
        'დაჯავშნეთ ტრეილის კომპლექტი ან ცალკეული აღჭურვილობა — ქირა დაიწყება პირველი შეკვეთიდან.',
      noOrdersFiltered: 'შეკვეთა ვერ მოიძებნა',
      noOrdersFilteredDesc: 'სცადეთ სხვა ნომერი ან გაასუფთავეთ ფილტრი.',
      bookKit: 'კომპლექტის დაჯავშნა',
      browseGear: 'აღჭურვილობის ნახვა',
      viewOrder: 'დეტალები',
      placedOn: 'თარიღი',
      ...
      total: 'სულ',
      loadPrevious: 'წინა გვერდი',
      loadMore: 'მეტის ნახვა',
      loading: 'იტვირთება…',
      statusPaid: 'გადახდილი',
      statusPending: 'მოლოდინში',
      statusRefunded: 'დაბრუნებული',
      statusFulfilled: 'დასრულებული',
      statusUnfulfilled: 'მიმდინარე',
      statusPartial: 'ნაწილობრივ',
    },
    cart: {
    ...
    footer: {
      ...
      returns: 'დაბრუნება',
      browseCta: 'კომპლექტების ნახვა',
      serviceGear: 'შემოწმებული პროფ. ინვენტარი',
      serviceMetro: 'მეტრო სადგურიდან — უფასოდ',
      serviceDelivery: 'სახლამდე მიტანა — 7 ლ',
      legal: 'იურიდიული',
      tagline:
        'პრემიუმ სალაშქრო ინვენტარის გაქირავება საქართველოში. ჩამოდი ცარიელი ხელებით.',
    },
    pages: {
      howItWorks: 'როგორ მუშაობს',
      delivery: 'მიწოდება',
  ...
  en: {
    ...
    gearBuilder: {
      ...
      saveAsNew: 'Save as a new build',
      startAnotherKit: 'Start another kit',
      cancelSave: 'Cancel',
    ...
    ordersPage: {
      title: 'Order history',
      subtitle: 'Your rentals and purchases in one place.',
      ...
      noOrdersDesc:
        'Book a trail kit or individual gear — your rental journey starts with your first order.',
      noOrdersFiltered: 'No matching orders',
      noOrdersFilteredDesc: 'Try a different number or clear the filters.',
      bookKit: 'Book a trail kit',
      browseGear: 'Browse gear',
    ...
    footer: {
      ...
      serviceGear: 'Pro gear, inspected',
      serviceMetro: 'Metro pickup — Free',
      serviceDelivery: 'Home delivery — 7 GEL',
      legal: 'Legal',
      tagline:
        'Premium camping gear rental in Georgia. Show up empty-handed.',
    },
    pages: {
      howItWorks: 'How it works',
      delivery: 'Delivery',
